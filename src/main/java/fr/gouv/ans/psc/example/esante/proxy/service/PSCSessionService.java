...
public class PSCSessionService {
	...
	public CIBASession cibaAuthentication(String bindingMessage, String nationalId, String clientId)
		...
		final ClientSecretBasic clientAuthentication = new ClientSecretBasic(new ClientID(clientId),
				new Secret(credential.secret()));
		...
		if (response.indicatesSuccess()) {
			...
			if (tokenResponse.indicatesSuccess()) {
				...
				return new CIBASession(
						...
						accessToken.getType().getValue(), idToken.getParsedString(),
